...
## VM IMPORT/EXPORT
* User Guide
  * https://docs.aws.amazon.com/zh_tw/vm-import/latest/userguide/what-is-vmimport.html

## AWS Service Migration Service
* User Guide
  * https://docs.aws.amazon.com/zh_tw/server-migration-service/latest/userguide/server-migration.html

## AWS RDS
* User Guide
  * https://docs.aws.amazon.com/zh_tw//AmazonRDS/latest/UserGuide/Welcome.html

## AWS Aurora
* User Guide
  * https://docs.aws.amazon.com/zh_tw/AmazonRDS/latest/AuroraUserGuide/CHAP_AuroraOverview.html

## AWS S3
* Develop Guide
  * https://docs.aws.amazon.com/zh_tw/AmazonS3/latest/dev/Welcome.html
* User Guide
  * https://docs.aws.amazon.com/zh_tw/AmazonS3/latest/user-guide/what-is-s3.html
...
## AWS ELB
* User Guide
  * https://docs.aws.amazon.com/zh_tw/elasticloadbalancing/latest/userguide/what-is-load-balancing.html
### Class Load Balancer
* User Guide
...
* User Guide
  * https://docs.aws.amazon.com/zh_tw/elasticloadbalancing/latest/network/introduction.html 
* elb log機制
    * https://docs.aws.amazon.com/zh_tw/elasticloadbalancing/latest/classic/access-log-collection.html
* 有listener說明
...
## AWS Config
* User Guide
  * https://docs.aws.amazon.com/zh_tw/config/latest/developerguide/WhatIsConfig.html

## AWS Glue
* User Guide
  * https://docs.aws.amazon.com/zh_tw/glue/latest/dg/what-is-glue.html

## AWS Athena
* User Guide
  * https://docs.aws.amazon.com/zh_tw/athena/latest/ug/what-is.html

## AWS Inspector
* User Guide
  * https://docs.aws.amazon.com/zh_tw/inspector/latest/userguide/inspector_introduction.html

## AWS Support
* User Guide
  * https://docs.aws.amazon.com/zh_tw/awssupport/latest/user/getting-started.html
...
## AWS Health 
* User Guide
  * https://docs.aws.amazon.com/zh_tw/health/latest/ug/what-is-aws-health.html
...
## AWS Service Catalog
* User Guide
  * https://docs.aws.amazon.com/zh_tw/servicecatalog/latest/adminguide/what-is_concepts.html

## AWS 官方文件
* 白皮書與指南
  * https://aws.amazon.com/tw/whitepapers/?whitepapers-main.sort-by=item.additionalFields.sortDate&whitepapers-main.sort-order=desc
* 企業領域應用
  * https://aws.amazon.com/tw/enterprise/
* AWS Builders Library
  * https://aws.amazon.com/tw/builders-library/?cards-body.sort-by=item.additionalFields.customSort&cards-body.sort-order=asc
* AWS Answer
...
* Disaster Recovery with Amazon Web Services: A Technical Guide
  * https://www.accenture.com/t20160617t064910__w__/us-en/_acnmedia/pdf-23/accenture-aaa%20-smart-disaster-recovery.pdf
